...
export const createCourseList = (courses) => {
  ...
  const enrollLink = createLink();
  enrollLink.setAttribute('href', './enroll.html');
  enrollLink.text = 'Registrera dig för kursen här!';
  enrollContainer.appendChild(enrollLink);
